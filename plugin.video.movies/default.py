# -*- coding: utf-8 -*-
# This plugin is an edited version of Divingmule's LiveStreams plugin.
...
addon = xbmcaddon.Addon(id='plugin.video.movies')
...
data = 'http://raw.github.com/exp-repo/exp-repo/master/movies.xml'
